...
export const DID_ACCESS_CONTROL_CONTRACT_ADDRESS = process.env.DID_ACCESS_CONTROL_CONTRACT_ADDRESS as string;
export const CONSENT_MANAGEMENT_CONTRACT_ADDRESS = process.env.CONSENT_MANAGEMENT_CONTRACT_ADDRESS as string;
