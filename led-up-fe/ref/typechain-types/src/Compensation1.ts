...
export interface Compensation1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "changeServiceFee"
      | "changeTokenAddress"
...
export interface Compensation1 extends BaseContract {
  connect(runner?: ContractRunner | null): Compensation1;
  waitForDeployment(): Promise<this>;

  interface: Compensation1Interface;
