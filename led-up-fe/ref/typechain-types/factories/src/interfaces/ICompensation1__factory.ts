...
import type {
  ICompensation1,
  ICompensation1Interface,
} from "../../../src/interfaces/ICompensation1";
...
export class ICompensation1__factory {
  static readonly abi = _abi;
  static createInterface(): ICompensation1Interface {
    return new Interface(_abi) as ICompensation1Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ICompensation1 {
    return new Contract(address, _abi, runner) as unknown as ICompensation1;
  }
}
