...
export class SymmetricCryptoService {
  ...
  public encrypt(
    ...
    try {
      ...
      const tag = algorithm !== SymmetricAlgorithm.AES_256_CBC ? cipher.getAuthTag().toString('hex') : '';
   ...
   * @throws Error if encryption fails
   */
  public encryptToString(data: string, key: CipherKey, algorithm: SymmetricAlgorithm = this.defaultAlgorithm): string {
