...
import { readLatestBlocks } from '../db/writeToDatabase';

const getCompletedBlocks = async function (req: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
