...
const tableService = TableServiceClient.fromConnectionString(
  process.env.TABLE_CONNECTION_STRING as string
);
 ...
 */
export const createTableClient = async (tableName: string): Promise<TableClient> => {
 ...
 */
export const addEntity = async (tableName: string, entity: any): Promise<any> => {
 ...
 */
export const updateEntity = async (tableName: string, entity: any): Promise<any> => {
  const tableClient = await createTableClient(tableName);
 ...
 */
export const deleteTable = async (tableName: string): Promise<any> => {
 ...
 */
export const performBatchAction = async (
  tableName: string,
  entities: TransactionAction[]
): Promise<any> => {
  const tableClient = await createTableClient(tableName);
