...
export type ProducerRegistrationParam = {
   ...
   *
   * @example "did:ledup:producer:123456789"
   */
  ownerDid?: string;
  ...
  /**
   * The DID of the updater, used when updating records.
   */
  updaterDid?: string;
};
...
export interface ProcessPaymentParams {
  ...
  /**
   * The DID of the consumer making the payment.
   *
   * @example "did:ledup:consumer:123456789"
   */
  consumerDid: string;
}
...
// Import and re-export all blockchain types
import * as BlockchainTypes from './blockchain-index';
export { BlockchainTypes };
