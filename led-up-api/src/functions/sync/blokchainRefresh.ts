...
import { getEntity, updateEntity } from '../../services/db/AzureTableService';
import { writeDatabase } from '../../services/db/writeToDatabase';
...
async function queryPastEvents(context: InvocationContext): Promise<BlockchainRecordType> {
  context.log('Querying past events from the blockchain...');
