...
describe('createDid function integration', () => {
  ...
  it('should handle blockchain interaction errors gracefully', async () => {
    // Mock request body
    const mockRequestBody: CreateDidRequest = {
      address: testAddress,
    };
    ...
    // Mock DidRegistryService.registerDid to throw a blockchain error
    const errorMessage = 'Blockchain interaction failed';
  ...
  it('should handle malformed address gracefully', async () => {
    // Mock request body with malformed address
    const mockRequestBody: CreateDidRequest = {
      address: 'not-a-valid-address',
    };
    (mockRequest.json as jest.Mock).mockResolvedValue(mockRequestBody);

    // Mock DidRegistryService.getDidForAddress to throw an error for invalid address
    mockDidRegistryService.getDidForAddress.mockRejectedValue(new Error('Invalid address format'));

    // Mock DidResolverService.createDid to throw an error for invalid address
  ...
  it('should handle network errors gracefully', async () => {
    ...
    // Mock DidRegistryService.getDidForAddress to throw a network error
    mockDidRegistryService.getDidForAddress.mockRejectedValue(new Error('Network error'));
    ...
    // Mock DidRegistryService.registerDid to throw a network error
    mockDidRegistryService.registerDid.mockRejectedValue(new Error('Network error'));
