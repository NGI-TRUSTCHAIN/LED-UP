...
<HeaderTitle title="Key Vault Service" source="https://github.com/LED-UP/LED-UP/tree/main/apis/auth" />
...
sequenceDiagram
    ...
    Encryption-->>KeyVault: keyPair
    KeyVault-->>Client: keyPair
...
| -------------------- | ----------- | ----------------------------------------------------- |
| Key not found        | 404         | Key with ID '&#123;keyIdValue&#125;' not found        |
| Invalid passphrase   | 401         | Invalid passphrase for key '&#123;keyIdValue&#125;'   |
| Storage failure      | 500         | Failed to store key '&#123;keyIdValue&#125;'          |
| Encryption failure   | 500         | Failed to encrypt data                                |
| Decryption failure   | 500         | Failed to decrypt key '&#123;keyIdValue&#125;'        |
| Signing failure      | 500         | Failed to sign data with key '&#123;keyIdValue&#125;' |
