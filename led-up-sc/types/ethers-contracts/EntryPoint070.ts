...
export interface EntryPoint070Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "balanceOf"
...
export interface EntryPoint070 extends BaseContract {
  connect(runner?: ContractRunner | null): EntryPoint070;
  waitForDeployment(): Promise<this>;

  interface: EntryPoint070Interface;
