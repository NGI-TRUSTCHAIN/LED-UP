...
export interface DataRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getCompensationAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getRecordProducer",
    values: [string]
  ): string;
  encodeFunctionData(
...
export namespace RecordVerifiedEvent {
  export type InputTuple = [recordId: string, verifier: AddressLike];
...
export interface DataRegistry extends BaseContract {
  ...
  checkAccess: TypedContractMethod<
    [recordId: string, consumerAddress: AddressLike],
    [
  ...
  getCompensationAddress: TypedContractMethod<[], [string], "view">;
  ...
  getRecordInfo: TypedContractMethod<
    [recordId: string],
    [
      [boolean, DataRegistry.ResourceMetadataStructOutput] & {
        isVerified: boolean;
        metadata: DataRegistry.ResourceMetadataStructOutput;
      }
    ],
    "view"
  >;

  getRecordProducer: TypedContractMethod<[recordId: string], [string], "view">;
  ...
  isAuthorizedProvider: TypedContractMethod<
    [_provider: AddressLike, recordId: string],
    [boolean],
    "view"
  >;

  isRecordVerified: TypedContractMethod<[recordId: string], [boolean], "view">;
  ...
  triggerAccess: TypedContractMethod<[recordId: string], [void], "nonpayable">;
  ...
  updateRecord: TypedContractMethod<
    [recordId: string, cid: string, contentHash: BytesLike],
    [void],
    "nonpayable"
  >;

  verifyRecord: TypedContractMethod<[recordId: string], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "getCompensationAddress"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "getRecordProducer"
  ): TypedContractMethod<[recordId: string], [string], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[recordId: string], [boolean], "view">;
  getFunction(
  ...
  filters: {
    "AccessGranted(string,address,string,uint40,uint8)": TypedContractEvent<
      AccessGrantedEvent.InputTuple,
      AccessGrantedEvent.OutputTuple,
      AccessGrantedEvent.OutputObject
    >;
    ...
    "AccessRevoked(string,address,string,address)": TypedContractEvent<
      AccessRevokedEvent.InputTuple,
      AccessRevokedEvent.OutputTuple,
      AccessRevokedEvent.OutputObject
    >;
    ...
    "AccessTriggered(string,address,string,uint8)": TypedContractEvent<
      AccessTriggeredEvent.InputTuple,
      AccessTriggeredEvent.OutputTuple,
      AccessTriggeredEvent.OutputObject
    >;
    ...
    "ConsumerAuthorized(string,address,uint8,uint40)": TypedContractEvent<
      ConsumerAuthorizedEvent.InputTuple,
      ConsumerAuthorizedEvent.OutputTuple,
      ConsumerAuthorizedEvent.OutputObject
    >;
    ...
    "ProviderAuthorized(string,address,uint8,uint40)": TypedContractEvent<
      ProviderAuthorizedEvent.InputTuple,
      ProviderAuthorizedEvent.OutputTuple,
      ProviderAuthorizedEvent.OutputObject
    >;
    ...
    "RecordRegistered(string,string,string,bytes32,address)": TypedContractEvent<
      RecordRegisteredEvent.InputTuple,
      RecordRegisteredEvent.OutputTuple,
      RecordRegisteredEvent.OutputObject
    >;
    ...
    "RecordStatusChanged(string,uint8,address)": TypedContractEvent<
      RecordStatusChangedEvent.InputTuple,
      RecordStatusChangedEvent.OutputTuple,
      RecordStatusChangedEvent.OutputObject
    >;
    ...
    "RecordUpdated(string,string,bytes32,address)": TypedContractEvent<
      RecordUpdatedEvent.InputTuple,
      RecordUpdatedEvent.OutputTuple,
      RecordUpdatedEvent.OutputObject
    >;
    ...
    "RecordVerified(string,address)": TypedContractEvent<
      RecordVerifiedEvent.InputTuple,
      RecordVerifiedEvent.OutputTuple,
      RecordVerifiedEvent.OutputObject
    >;
